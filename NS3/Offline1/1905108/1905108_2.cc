...
// Default Network Topology: mobile
//
//   Wifi2 10.1.3.0
//                 AP
//  *    *    *    *
...
main(int argc, char* argv[])
{
    ...
    uint32_t spd=5;
    std::string speed=std::to_string(spd);
    ...
    throughPutStream  = asciiTraceHelper.CreateFileStream("scratch/1905108/1905108_2throughput.dat", std::ios::out|std::ios::app);
    deliveryStream  = asciiTraceHelper.CreateFileStream("scratch/1905108/1905108_2delivery.dat", std::ios::out|std::ios::app);
    ...
    cmd.AddValue("speed", "Speed of Nodes", spd);
    ...
    nWifi1=nWifi/2;
    nWifi2=nWifi/2;
    speed=std::to_string(spd);

    std::cout<<nWifi<<" "<<nflow<<" "<<pcktRate<<" "<<speed<<std::endl;
...
//wifi2
    ...
    mobility.SetMobilityModel("ns3::RandomWalk2dMobilityModel",
                              ...
                              "Speed",
                              StringValue ("ns3::ConstantRandomVariable[Constant="+speed+"]"));
    ...
    else if(graphType==4){//speed vs th,delv
        *throughPutStream->GetStream()<<speed<<"\t"<<throughput<<"\n";
        *deliveryStream->GetStream()<<speed<<"\t"<<deliveryRatio<<"\n";      
    }
